...
const clienteSchema = new mongoose.Schema({ // Criando a tabela no banco de dados ; 
    ...
    email: {type: String, required: true, unique: true}, // Criando o campo "Email";
    pedidos: [{type: mongoose.Schema.Types.ObjectId, ref: "Pedidos"}] // Criando o campo pedidos vinculado a esse cliente ; 
})
